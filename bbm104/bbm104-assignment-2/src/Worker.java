public class Worker extends Employee {
    ...
    private static final int DAILY_WORKING_FEE = 105;
    private static final int WEEKLY_OVERWORK_HOUR_LIMIT = 10;
    private static final int HOURLY_OVERWORK_FEE= 11;
    private static final int WEEKLY_BASE_WORKING_HOUR = 40;
    private static final int WEEKLY_WORK_DAY_NUMBER = 5;

    public Worker(String firstName, String lastName, String registerNumber, int yearOfStart) {
    ...
    public double getWeeklySalary(int weeklyWorkingHour) {
        double weeklyBaseWorkingFee = WEEKLY_WORK_DAY_NUMBER * DAILY_WORKING_FEE;
